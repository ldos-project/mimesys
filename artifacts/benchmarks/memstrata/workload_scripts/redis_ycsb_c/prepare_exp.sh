...
sed -i 's/operationcount=.*/operationcount=15000000/' workloads/workloadc
sed -i 's/requestdistribution=.*/requestdistribution=zipfian/' workloads/workloadc

python2 ./bin/ycsb load redis -s -P workloads/workloadc -p "redis.host=127.0.0.1" -p "redis.port=6379" -p "threadcount=3"
