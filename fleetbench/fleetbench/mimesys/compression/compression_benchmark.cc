...
#include "fleetbench/mimesys/compression/algorithms.h"
#include "fleetbench/mimesys/compression/compression_parameter.h"
...
class CompressionCorpus {
 public:
  explicit CompressionCorpus() {
    ...
    int error = 0;
    auto corpus_path =
        absl::StrCat(GetFleetbenchRuntimePath("mimesys/"), "corpus.zip");
