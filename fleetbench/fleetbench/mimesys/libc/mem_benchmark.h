...
inline absl::NoDestructor<absl::flat_hash_map<std::string, benchmark::IterationCount>>
    kDefaultBenchmarks({{"BM_LIBC_Bcmp_Fleet_L1", 1},
                        ...
                        {"BM_LIBC_Bcmp_Fleet_L2", 1},
                        {"BM_LIBC_Memcmp_Fleet_L2", 1},
                        {"BM_LIBC_Memcpy_Fleet_L2", 1},
                        {"BM_LIBC_Memmove_Fleet_L2", 1},
                        {"BM_LIBC_Memset_Fleet_L2", 1},
                        {"BM_LIBC_Bcmp_Fleet_LLC", 1},
                        {"BM_LIBC_Memcmp_Fleet_LLC", 1},
                        {"BM_LIBC_Memcpy_Fleet_LLC", 1},
                        {"BM_LIBC_Memmove_Fleet_LLC", 1},
                        {"BM_LIBC_Memset_Fleet_LLC", 1},
